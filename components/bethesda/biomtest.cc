...
int main() {
  ...
  rx::bethesda::BiomeMap map = rx::bethesda::ParseBiomeMap(rx::ByteSpan(blob.data(), blob.size()));
  ...
  base::Vector<u8> truncated(blob.begin(), blob.begin() + 100);
