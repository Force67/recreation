...
bool ParseCtda(ByteSpan data, Comparison* out) {
  ...
  c.run_on =
      run_on <= static_cast<u32>(RunOn::kEventData) ? static_cast<RunOn>(run_on) : RunOn::kSubject;
  c.reference = U32(24);
