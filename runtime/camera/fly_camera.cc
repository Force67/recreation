...
void FlyCamera::Update(const InputState& input,
  ...
  if (actions.down(Action::kCamUp) || actions.down(Action::kJump))
    move += Vec3{0, 1, 0};
  if (actions.down(Action::kCamDown) || actions.down(Action::kSneak))
    move += Vec3{0, -1, 0};
