#ifndef RECREATION_RUNTIME_CHARACTER_FP_EQUIPMENT_H_
#define RECREATION_RUNTIME_CHARACTER_FP_EQUIPMENT_H_
...
#endif  // RECREATION_RUNTIME_CHARACTER_FP_EQUIPMENT_H_
