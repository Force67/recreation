...
// engine-space transform (position, quaternion, native scale). The file is a
// tiny line-based format so it stays diff-friendly and dependency-free; the
...
#endif  // RECREATION_RUNTIME_EDITOR_EDITOR_LAYOUT_H_
