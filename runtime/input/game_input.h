#ifndef RECREATION_RUNTIME_INPUT_GAME_INPUT_H_
#define RECREATION_RUNTIME_INPUT_GAME_INPUT_H_
...
enum class Action : ActionId {
  ...
  kMenuPageLeft,
  kMenuPageRight,
  // Draw / sheathe the most recently picked-up weapon in first person (X).
  // Appended last to keep the numeric ids append-only.
  kEquipWeapon,
  kCount,
};
...
#endif  // RECREATION_RUNTIME_INPUT_GAME_INPUT_H_
